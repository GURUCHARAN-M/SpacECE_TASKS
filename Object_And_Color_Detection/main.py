...
def process_images(input_folder, output_folder, config_path, weights_path, classes_path):
    ...
    for image_file in image_files:
        ...
        if frame is None:
            ...
            continue
        processed_frame = detect_objects(net, output_layers, frame.copy(), classes)
        ...
        output_path = os.path.join(output_folder, f"{os.path.splitext(image_file)[0]}_processed.jpg")
        cv2.imwrite(output_path, processed_frame)

if __name__ == "__main__":
    input_folder = r"C:\\Users\\gurum\\Desktop\\SpacECE_TASKS\\Object_And_Color_Detection\\images"
    output_folder = r"C:\\Users\\gurum\\Desktop\\SpacECE_TASKS\\Object_And_Color_Detection\\outputs"
    ...
    process_images(input_folder, output_folder, config_path, weights_path, classes_path)
